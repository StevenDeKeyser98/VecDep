#' @title Helhac
#'
#' @description This function computes the Hellinger distance between all the child copulas of an hac object obtained by the function \code{\link{gethac}}, i.e.,
